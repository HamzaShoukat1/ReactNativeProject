...
import { formatPrice, getGreeting } from '@/lib/utils/utils'
...
export default function homeScreen() {
  ...
  const monthTransactions = useMemo(() => {
    ...
    return transactions.filter((tx) => isSameMonth(new Date(tx.date), nowData))
      ...
      >
        ...
        <View className="bg-brand-bg rounded-b-[28px] px-5 pt-5 pb-[22px]">
          ...
          <View className="mb-[22px]">
            ...
            {loading ? (
              <View className="h-[46px] justify-center items-start">
